...
templates['dataTable'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<table class=\"dataTable\">\r\n    <thead>\r\n        <tr>\r\n"
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,(depth0 != null ? lookupProperty(depth0,"headers") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":5,"column":12},"end":{"line":9,"column":21}}})) != null ? stack1 : "")
    + "        </tr>\r\n    </thead>\r\n    \r\n    <tbody>\r\n            <tr>\r\n"
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,(depth0 != null ? lookupProperty(depth0,"tableData") : depth0),{"name":"each","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":16,"column":16},"end":{"line":20,"column":25}}})) != null ? stack1 : "")
    + "            </tr>\r\n            \r\n    </tbody>\r\n</table>";
},"useData":true});
